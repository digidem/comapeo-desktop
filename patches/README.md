...
### [Do not watch fallback map patch when setting up SMP server plugin](./@comapeo+core+8.0.0-next.2+001+fix-smp-fallback-map-setup.patch)
...
### [Do not exit the process on republishing errors](./@homebridge+ciao+1.3.12+001+handle-republish-errors.patch)
