...
### [Do not watch fallback map patch when setting up SMP server plugin](./@comapeo+core+5.4.1+001+fix-smp-fallback-map-setup.patch)
...
### [Define `comapeo:` protocol as safe](./@tanstack+router-core+1.159.4+001+define-custom-protocol-as-safe.patch)
