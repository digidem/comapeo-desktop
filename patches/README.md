...
### [Do not watch fallback map patch when setting up SMP server plugin](./@comapeo+core+5.2.0+001+fix-smp-fallback-map-setup.patch)
...
### [Fix CORS issue when getting custom map info when in development](./@comapeo+core+5.2.0+002+fix-custom-map-info-cors.patch)
