...
### [Do not watch fallback map patch when setting up SMP server plugin](./@comapeo+core+7.4.0+001+fix-smp-fallback-map-setup.patch)
...
### [Do not exit the process on republishing errors](./@homebridge+ciao+1.3.10+001+handle-republish-errors.patch)
