			...
			>
				...
				>
					<Box alignSelf="center">
						<Icon name="material-category" htmlColor={DARK_ORANGE} size={128} />
					</Box>
					...
					{projectSettings.configMetadata?.name === DEFAULT_CATEGORIES_NAME ? (
						<List
							sx={{ listStyleType: 'disc', paddingInline: 8, color: DARK_GREY }}
						>
						...
						onClick={() => {
							selectCategoriesFile.mutate(undefined, {
								...
								onSuccess: async (fileInfo) => {
									...
									return importCategoriesFile.mutateAsync({
